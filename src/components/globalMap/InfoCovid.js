              ...
              <footer className="bg-light text-center text-lg-start">
               ...
               <div className="container p-4">
                  ...
                  <div className="row">
                     ...
                     <h5 className="text-uppercase"> The application displays  </h5>

                     <p>
                      resource to help advance
                      the understanding of the virus, inform the public,
                      and brief policymakers in order to guide a response, 
                      improve care, and save lives.
                     </p>
                     </div>
                     
                     <div className="col-lg-6 col-md-12 mb-4 mb-md-0">
                     <h5 className="text-uppercase">Covid-19 Global</h5>

                     <p>
                      The virus continues to affect every 
                      region of the world, but some countries
                      are experiencing high rates of infection, 
                      while others appear to have mostly controlled the virus.
                     </p>
                     </div>
